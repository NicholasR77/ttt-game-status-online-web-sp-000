...
def won?(board)
  WIN_COMBINATIONS.each do |win_combination|
    ...
    win_index_2 = win_combination[5]
    win_index_3 = win_combination[6]
    win_index_1 = win_combination[7]
    win_index_2 = win_combination[8]
    ...
    if position_1 == "X" && position_2 == "X" && position_3 == "X" && position_4 == "X" && position_5 == "X" && position_6 == "X" && position_7 == "X" && position_8 == "X"
